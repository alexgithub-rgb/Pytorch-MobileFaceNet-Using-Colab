...
class MobileFaceNet(Module):
    def __init__(self):
        ...
        #64, 128->64,64
        self.conv_34 = DepthWise(64, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=256)
        #128->64
        self.conv_4 = Residual(64, num_block=6, groups=256, kernel=(3, 3), stride=(1, 1), padding=(1, 1))
        #128->64
        self.conv_45 = DepthWise(64, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=512)
